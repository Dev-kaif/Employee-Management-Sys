      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-lg text-white/90 mb-8">
            Join thousands of companies that use EmpManage to streamline their HR operations, boost productivity, and
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-[#2563EB] hover:bg-white/90 active:bg-white/80"
